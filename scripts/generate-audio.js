...
const vocabulary = [
  // Letters (vowels) - just the vowel sound
  { sinhala: "අ", speak: "අ", type: "letter" },
  { sinhala: "ආ", speak: "ආ", type: "letter" },
  { sinhala: "ඇ", speak: "ඇ", type: "letter" },
  { sinhala: "ඈ", speak: "ඈ", type: "letter" },
  { sinhala: "ඉ", speak: "ඉ", type: "letter" },
  { sinhala: "ඊ", speak: "ඊ", type: "letter" },
  { sinhala: "උ", speak: "උ", type: "letter" },
  { sinhala: "ඌ", speak: "ඌ", type: "letter" },
  { sinhala: "ඍ", speak: "ඍ", type: "letter" },
  { sinhala: "ඎ", speak: "ඎ", type: "letter" },
  { sinhala: "ඏ", speak: "ළි", type: "letter" },
  { sinhala: "ඐ", speak: "ළී", type: "letter" },
  { sinhala: "එ", speak: "එ", type: "letter" },
  { sinhala: "ඒ", speak: "ඒ", type: "letter" },
  { sinhala: "ඓ", speak: "ඓ", type: "letter" },
  { sinhala: "ඔ", speak: "ඔ", type: "letter" },
  { sinhala: "ඕ", speak: "ඕ", type: "letter" },
  { sinhala: "ඖ", speak: "ඖ", type: "letter" },
