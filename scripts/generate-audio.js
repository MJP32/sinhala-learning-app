...
const vocabulary = [
  // Letters (vowels) - use extended pronunciation for better TTS
  { sinhala: "අ", speak: "අ අ අ", type: "letter" },
  { sinhala: "ආ", speak: "ආ ආ ආ", type: "letter" },
  { sinhala: "ඇ", speak: "ඇ ඇ ඇ", type: "letter" },
  { sinhala: "ඈ", speak: "ඈ ඈ ඈ", type: "letter" },
  { sinhala: "ඉ", speak: "ඉ ඉ ඉ", type: "letter" },
  { sinhala: "ඊ", speak: "ඊ ඊ ඊ", type: "letter" },
  { sinhala: "උ", speak: "උ උ උ", type: "letter" },
  { sinhala: "ඌ", speak: "ඌ ඌ ඌ", type: "letter" },
  { sinhala: "ඍ", speak: "ඍ ඍ ඍ", type: "letter" },
  { sinhala: "ඎ", speak: "ඎ ඎ ඎ", type: "letter" },
  { sinhala: "ඏ", speak: "ළි ළි ළි", type: "letter" },
  { sinhala: "ඐ", speak: "ළී ළී ළී", type: "letter" },
  { sinhala: "එ", speak: "එ එ එ", type: "letter" },
  { sinhala: "ඒ", speak: "ඒ ඒ ඒ", type: "letter" },
  { sinhala: "ඓ", speak: "ඓ ඓ ඓ", type: "letter" },
  { sinhala: "ඔ", speak: "ඔ ඔ ඔ", type: "letter" },
  { sinhala: "ඕ", speak: "ඕ ඕ ඕ", type: "letter" },
  { sinhala: "ඖ", speak: "ඖ ඖ ඖ", type: "letter" },
  // Letters (consonants) - single sound
  { sinhala: "ක", speak: "ක", type: "letter" },
  { sinhala: "ඛ", speak: "ඛ", type: "letter" },
  { sinhala: "ග", speak: "ග", type: "letter" },
  { sinhala: "ඝ", speak: "ඝ", type: "letter" },
  { sinhala: "ඞ", speak: "ඞ", type: "letter" },
  { sinhala: "ච", speak: "ච", type: "letter" },
  { sinhala: "ඡ", speak: "ඡ", type: "letter" },
  { sinhala: "ජ", speak: "ජ", type: "letter" },
  { sinhala: "ඣ", speak: "ඣ", type: "letter" },
  { sinhala: "ඤ", speak: "ඤ", type: "letter" },
  { sinhala: "ට", speak: "ට", type: "letter" },
  { sinhala: "ඨ", speak: "ඨ", type: "letter" },
  { sinhala: "ඩ", speak: "ඩ", type: "letter" },
  { sinhala: "ඪ", speak: "ඪ", type: "letter" },
  { sinhala: "ණ", speak: "ණ", type: "letter" },
  { sinhala: "ත", speak: "ත", type: "letter" },
  { sinhala: "ථ", speak: "ථ", type: "letter" },
  { sinhala: "ද", speak: "ද", type: "letter" },
  { sinhala: "ධ", speak: "ධ", type: "letter" },
  { sinhala: "න", speak: "න", type: "letter" },
  { sinhala: "ප", speak: "ප", type: "letter" },
  { sinhala: "ඵ", speak: "ඵ", type: "letter" },
  { sinhala: "බ", speak: "බ", type: "letter" },
  { sinhala: "භ", speak: "භ", type: "letter" },
  { sinhala: "ම", speak: "ම", type: "letter" },
  { sinhala: "ය", speak: "ය", type: "letter" },
  { sinhala: "ර", speak: "ර", type: "letter" },
  { sinhala: "ල", speak: "ල", type: "letter" },
  { sinhala: "ව", speak: "ව", type: "letter" },
  { sinhala: "ශ", speak: "ශ", type: "letter" },
  { sinhala: "ෂ", speak: "ෂ", type: "letter" },
  { sinhala: "ස", speak: "ස", type: "letter" },
  { sinhala: "හ", speak: "හ", type: "letter" },
  { sinhala: "ළ", speak: "ළ", type: "letter" },
  { sinhala: "ෆ", speak: "ෆ", type: "letter" },
  // Words
